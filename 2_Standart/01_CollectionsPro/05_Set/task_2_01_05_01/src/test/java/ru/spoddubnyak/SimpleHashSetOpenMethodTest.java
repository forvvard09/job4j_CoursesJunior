...
/**
 * Tests class  SimpleHashSetOpenMethod.
 *
 ...
 * @since 07.08.2017
 */
public class SimpleHashSetOpenMethodTest<E> {
    /**
    ...
    public void whenAddNewElementThenGetNewElement() {
        SimpleHashSetOpenMethod<E> set = new SimpleHashSetOpenMethod<E>();
        set.add((E) this.testDataSet[0]);
        final int expectedSize = 1;
        assertThat(set.getSizeSet(), is(expectedSize));
        set.existenceValid((E) this.testDataSet[1]);
    ...
    public void whenThenGetOne() {
        SimpleHashSetOpenMethod<String> set = new SimpleHashSetOpenMethod<String>(0);
        int expectedIndex = 0;
